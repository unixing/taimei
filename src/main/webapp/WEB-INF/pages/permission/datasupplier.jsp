...
<body onload="search()">
	<div class="mask"></div>
	<div class="warp">
		<div id="show_content" class="show_content"></div>
	</div>
			...
			<table class="table">
				<tr>
					<td><input type="button" class="btn btn-success" value="添加"
						...
						class="btn btn-success" value="分配角色" onclick="showroles();">
					</td>
					<td>
						<form id="systemLog-searchForm" method="post"
							enctype="application/x-www-form-urlencoded">
							公司名称: <input name="cpyNm" style="width: 120px"
								placeholder="请输入公司名称"> <input type="button"
	...
	<%@include file="/WEB-INF/pages/permission/js/datasupplier.jsp"%>
