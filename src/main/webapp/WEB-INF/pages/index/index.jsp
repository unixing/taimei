...
<script type="text/javascript">
	...
	menus2.forEach(function(val){
		console.log(val.id+"="+val.name+"="+val.type);
	})
</script>
        ...
        <div class="pla-tool-iList">
            <div class="pla-tool-img">
	            <%
	             ...
	             %>
                	<img class="small-head" src="${user_in_session.headPath}"  onerror="javascript:this.src='http://img1.3lian.com/2015/gif/w/74/43.jpg'">
                <%}else{ %>
                	<img class="small-head" src="/css/images/ph.jpg"   onerror="javascript:this.src='http://img1.3lian.com/2015/gif/w/74/43.jpg'">
                <%} %>
            </div>
    ...
    <div class="pla-search">
    	...
    	<div class="pla-search-panel">
		    ...
		    <div class="pla-search-panel-body">
		    	<input id="pla-search-id" type="text" placeholder="输入航班号后敲击回车搜索">
			</div>
		</div>
    </div>
    </div>
