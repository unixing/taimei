...
//	changeDate('reservation');
	...
	if(parent.supData.linFlag == "0"){
		var divv = "<ul><li class='tltle-sel' title='销售报表' id='_permissions_13'><a class='page-fun-change' href='/salesReport'>&#xe628;</a></li><li class='tltle-sel tltle-selI' id='_permissions_1'>&#xe629;<span>航线历史收益统计</span></li><li class='tltle-sel' title='销售动态' id='_permissions_5'><a class='page-fun-change' href='/buyTicketReport'>&#xe624;</a></li></li><li class='tltle-sel' title='销售数据' id='_permissions_8'><a class='page-fun-change' href='/SalesData/accountCheck'>&#xe688;</a></li></ul>";
...
function addElement(){
    ...
    if(data1.hasStopping){
        ...
        if(ndata[1]==''){
        	if(flagMap[data1.hasStopping]=="0"){
        		...
        		ele="<div class='body-navigation-element set' tag = '"+ndata[0]+'='+ndata[2]+"'><div class='tag-box'><div>"+ndata[0]+"</div> <div class='element-tag'>&#xe648;&#xe647;</div><div>"+ndata[2]+"</div> </div> </div>";
        	}
            for(var key in data1.pieceData){
                ...
                if(flagMap[key]=="0"){
                	...
                	ele+="<div class='body-navigation-element' tag = '"+key+"'><div class='tag-box'> <div>"+ndata[0]+"</div><div class='element-tag'>&#xe648;</div><div>"+ndata[1]+"</div></div></div>";
                }
              }
        }else{
        	if(flagMap[data1.hasStopping]=="0"){
        		...
        		ele="<div class='body-navigation-element set' tag = '"+ndata[0]+'='+ndata[1]+'='+ndata[2]+"'><div class='tag-box'><div>"+ndata[0]+"</div> <div class='element-tag'>&#xe648;&#xe647;</div><div>"+ndata[1]+"</div><div class='element-tag'>&#xe648;&#xe647;</div><div>"+ndata[2]+"</div> </div> </div>";
        	}
        	for(var key in data1.pieceData){
                ndata=key.split("-");
                if(flagMap[key]=="0"){
