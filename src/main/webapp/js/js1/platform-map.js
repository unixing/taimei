...
//	console.log(cityCoordinateList);
...
/********************************************地图JS*************************************************************/
    ...
    $('.material-fact-installBox').on('click','label',function(){
...
//    	                    getCurrentSeasonFocusFlts(0);//获取所有航班列表
    	                    ...
    	                    var hong="";	//装航班号
    	                    var hbiata=[];	//装三字码
    	                    $.each(data.success.airportOnLineData,function(i,el){
    	                    	var b = el.flyNum.split(",");
    	                    ...
    	                    parent.searchNum=lhlhlh;    	                	
    	                	parent.searchCNnum=hbiata;
    	                	parent.airFlyIata=data.success.airportOnLineData;
    	...
    	$.ajax(
		        {
		            ...
		            success : function(data) {
		                if(data){
		                	...
		                	parent.portinfo=airData["listData"];		                	
		                }
...
//		                })
    ...
    /*提示框动态设置*/
    parent.chart_openTool=function(params){    
        ...
        if(params.seriesType=="lines"){
        	...
        	//$(".pla-promptBox").css({"right":"100px","top":"20%"});
            var tipright='';
    ...
    myChart.on('click', function (params) {
    	parent.chart_openTool(params);
    	//chart_openTool(params);
...
//	            			if(JSON.stringify(dats2)=="{}"){
//	            				dats2 = JSON.parse(JSON.stringify(DataList.data2[i].allLine));
//	            				dats2.title = airportName + "=" + onName;
//	            				for(var j = 0;j<dats2.period.length;j++){
//	            					dats2.period[j].name = airportMap[airportCode].aptChaNam + "-" + airportMap[dats2.period[j].code.split("-")[1]].aptChaNam;
//	            					dats2.period[j].code = airportMap[airportCode].iata + "-" + airportMap[dats2.period[j].code.split("-")[1]].iata;
...
////            						var liness = {'code':'LZO-NAY','flyNumber':'[HU1111/12]','name':'泸州蓝田-北京南苑'} ;
//            						for(var n=0;n<dats2.period.length;n++){
//	            						var coden = dats2.period[n].code.split("-");
//	            						if(coden[1]==codem[1]){
//	    	            					var lines1 = dats2.period[m].lines;
//	    	            					dats2.period[m].name = airportMap[airportCode].aptChaNam + "-" + airportMap[codem[1]].aptChaNam;
//	    	            					dats2.period[m].code = airportMap[airportCode].iata + "-" + airportMap[codem[1]].iata;
//	    	            					var retline = new Array();
////	    	            					retline = liness;
////	    	            					for ( var int = 0; int < liness.length; int++) {
////	    	            						retline.push(liness[int]);
////											}
//	    	            					retline = JSON.parse(JSON.stringify(liness));
//	    	            					//去掉重复的数据
//	    	            					for ( var jj = 0; jj < lines1.length; jj++) {
...
//	    	            						}
//	    									}
//	    	            					dats2.period[m].lines = retline;
//	    	            					falge = false;
//	            						}
//	            					}
//            						if(falge){
//            							//新加一个period
//            							var Myperiod = new Object();
//            							Myperiod.name = airportMap[airportCode].aptChaNam + "-" + airportMap[codem[1]].aptChaNam;
//            							Myperiod.code = airportMap[airportCode].iata + "-" + airportMap[codem[1]].iata;
////            							var retline = new Array();
////    	            					for ( var int = 0; int < liness.length; int++) {
////    	            						retline.push(liness[int]);
////										}
//            							Myperiod.lines = JSON.parse(JSON.stringify(liness));
//            							dats2.period.push(Myperiod);
//            						}
//            					}
//	            			}
//	            		}
               ...
               if($(this).hasClass("_mid-t")){
                   ...
                   if(!$(this).hasClass("_tipTile")){
                	   ...
                	   if(lesss.indexOf(abbrs)!=-1){
                		   $(".pla-prompRight-box").html("<div style='display:"+perm.show13+"'><div class='pla-prompTip-ico'>&#xe628;</div><div class='pla-prompTip-des'>销售报表</div></div><div style='display:"+perm.show1+"'><div class='pla-prompTip-ico'>&#xe629;</div><div class='pla-prompTip-des'>航线历史收益统计</div></div><div style='display:"+perm.show5+"'><div class='pla-prompTip-ico'>&#xe624;</div><div class='pla-prompTip-des'>销售动态</div></div><div style='display:"+perm.show8+"'><div class='pla-prompTip-ico'>&#xe688;</div><div class='pla-prompTip-des'>销售数据</div></div>")
                		   ...
                		   $(".pla-prompRight-box").html("<div style='display:"+perm.show13+"'><div class='pla-prompTip-ico'>&#xe628;</div><div class='pla-prompTip-des'>销售报表</div></div><div style='display:"+perm.show1+"'><div class='pla-prompTip-ico'>&#xe629;</div><div class='pla-prompTip-des'>航线历史收益统计</div></div><div style='display:"+perm.show8+"'><div class='pla-prompTip-ico'>&#xe688;</div><div class='pla-prompTip-des'>销售数据</div></div>")
...
//【874机场视图功能延伸】longhong
	...
	function turn_on_this_plane(iata,hx,air){
		...
		//console.log(this_data.series[0]);
