...
<link rel="stylesheet" type="text/css"href="/css/css<%=request.getSession().getServletContext().getAttribute("versionn") %>/newPageCss/account-check/jPages.css" /> --%>
</head>
    ...
    <div class="lin-historical">
        <div class="sr-box-head">
            <div class="sr-box-head-classify">
                <ul>
             	    <li class='tltle-sel' title='销售报表'><a class='page-fun-change' href='/salesReport'>&#xe628;</a></li>
                    <li class='tltle-sel' title='航线历史收益统计'><a class='page-fun-change' href='/airline'>&#xe629;</a></li>
                    <li class='tltle-sel' title='销售动态'><a class='page-fun-change' href='/buyTicketReport'>&#xe624;</a></li>
                    <li class='tltle-sel tltle-selI'>&#xe688;<span>销售数据</span></li>
                </ul>
            </div>
            <div class="sr-box-head-inquire" id='sr-box-head-inquire'>
                ...
                <div class="_set-flight">
                    ...
                    <div class="_set-list-set"><input id="SD-head-inquire" type="text"></div>
                </div>
                <div class="_set-time">
                ...
                <div class="_set-place-duplexing">
                    ...
                    <div class="SD-airportNam">123456</div>
                </div>
