    	...
    	$.ajax(
    	    	{
    	            ...
    	            success : function(data) {
    	            	...
    	            	var list={
    	            	    ...
    	            	    var lls =lane.split("=");
    	            	    //改变右边航线
        	        		$(".change-line-f").find("p").html(airports[lls[0]].iata);
        	            	$(".change-line-f").find("div").html(airports[lls[0]].aptChaNam);
        	            	
        	            	$(".change-line-o").find("p").html(airports[lls[1]].iata);
        	            	$(".change-line-o").find("div").html(airports[lls[1]].aptChaNam);
        	            	
        	            	$(".change-line-l").find("p").html(airports[lls[2]].iata);
        	            	$(".change-line-l").find("div").html(airports[lls[2]].aptChaNam);
    	            },
    	            error : function() {}
    	        }
    	    );
